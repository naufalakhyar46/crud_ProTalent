...
class ApiService {
  ...
  public static init(app: App<Element>) {
    ...
    ApiService.vueInstance.axios.defaults.baseURL = import.meta.env.VITE_VUE_APP_API_URL
  }
  ...
  public static setHeader(req = null): void {
    if (req != null) {
      ApiService.vueInstance.axios.defaults.headers.common['Content-Disposition'] =
      ...
      delete ApiService.vueInstance.axios.defaults.headers.common['Content-Disposition']
      delete ApiService.vueInstance.axios.defaults.headers.common['Content-Type']
